...
This version of the module only works with Drupal 5.0.0.
...
3. Enable the "Meta tags" module from the module administration page (administer
   >> site configuration >> modules).

   The needed tables will be automatically created. If this fails, you may
   use the nodewords.mysql or nodewords.pgsql files to create the table
   manually.
   ...
   Do not forget to adjust the nodewords.mysql or nodewords.pgsql file to
   work with your table prefix if you use table prefixing.
...
3. On the front page meta tags settings page ("administer >> content management
   >> meta tags >> front page") you can specify the meta tags to use on the
...
1. Create a "Free tagging" vocabulary at "administer >> content management
   >> categories". Eg call this vocabulary "Keywords".
...
page (administer >> settings >> meta tags). Unfortunately, for CCK
(Content Construction Kit) content types, this teaser is not really
...
$Id: README.txt,v 1.21.4.1 2006/12/19 10:50:51 robrechtj Exp $
